...
class MenuScreen: SKScene {
    ...
    override func didMove(to view: SKView) {
        ...
        z1 = childNode(withName: "z1") as! SKSpriteNode
        z2 = childNode(withName: "z2") as! SKSpriteNode
        z3 = childNode(withName: "z3") as! SKSpriteNode
    ...
    func animationSetup() {
        ...
        let frames = SKAction.animate(with: textures, timePerFrame: 0.3, resize: true, restore: false)
    ...
    func zAnimation() {
        let z1alpha1 = SKAction.fadeAlpha(to: 0, duration: 1)
        let z1alpha2 = SKAction.fadeAlpha(to: 1, duration: 1)
        
        z1.run(.repeatForever(.sequence([z1alpha1, z1alpha2])))
        z2.run(.repeatForever(.sequence([z1alpha1, z1alpha2])))
        z3.run(.repeatForever(.sequence([z1alpha1, z1alpha2])))
    }
